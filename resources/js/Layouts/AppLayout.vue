<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 font-cairo" :dir="$page.props.locale === 'العربية' ? 'rtl' : 'ltr'">
            <nav class="bg-gradient-to-r from-teal-500 to-cyan-600  text-white border-b border-gray-100">
                                ...
                                <jet-dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <a
                                            ...
                                            v-for="(locale, index) in $page.props.supportedLocales" :key="index"
                                            :hrefLang="index"
                                            :href="localizedUrl(index)"
                                        >
                                            {{ locale.native }}
                                        </a>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('items.index')" :active="route().current('items.index')">
                            {{ $t('Items')}}
                        </jet-responsive-nav-link>
