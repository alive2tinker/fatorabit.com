<template>
    ...
    -->
        ...
        <div
            v-if="$page.props.user.invoiceCount >= 5 && $page.props.user.type === 'free'"
            class="fixed z-10 inset-0 overflow-y-auto"
            aria-labelledby="modal-title"
            role="dialog"
            aria-modal="true"
                    ...
                    <div>
                        ...
                        <div class="mt-3 text-center sm:mt-5">
                            <h3
                                ...
                                id="modal-title"
                            >
                                {{ $t("Reached subscription invoicing limit") }}
                            </h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    {{
                                        $t(
                                            "You cannot create any more invoices on current subscription plan. kindly upgrade yours"
                                        )
                                    }}
                                </p>
                            </div>
